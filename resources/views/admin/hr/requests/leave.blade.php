                                ...
                                <div class="modal fade" id="approveModal{{ $req->id }}" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <form action="{{ route('hr.requests.leave.action', $req->id) }}" method="POST">
                                                @csrf
                                                ...
                                                <div class="modal-body">
                                                    <p>Are you sure you want to approve this leave request for <strong>{{ $req->total_days }}</strong> days?</p>
                                                    <p class="text-muted"><small>This will automatically deduct {{ $req->total_days }} days from their leave balance.</small></p>
                                                    <div class="mb-3">
