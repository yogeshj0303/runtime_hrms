...
@section('title') Helpdesk Requests @endsection
...
<div class="helpdesk-header">
    ...
    <div class="header-content">
        <div class="header-left">
            <h4>Helpdesk Permission Requests</h4>
        </div>
    </div>
</div>
                    ...
                    <table id="pending-table" class="table table-bordered table-striped dt-responsive nowrap align-middle" style="width:100%">
                        ...
                        <tbody>
                            @foreach($pendingRequests as $req)
                                <tr>
                                    <td>{{ $req->employee->first_name ?? 'N/A' }} {{ $req->employee->last_name ?? '' }}</td>
                                    <td>{{ $req->reason }}</td>
                                    <td>
                                ...
                                <div class="modal fade" id="approveModal{{ $req->id }}" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <form action="{{ route('hr.requests.helpdesk.action', $req->id) }}" method="POST">
                                                @csrf
                                                <input type="hidden" name="action" value="approve">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">Approve Helpdesk Permission</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <p>Are you sure you want to approve this request?</p>
                                                    <p class="text-muted"><small>This will grant the employee access to view helpdesk tickets across all departments.</small></p>
                                                    <div class="mb-3">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="submit" class="btn btn-success">Approve & Grant Access</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <form action="{{ route('hr.requests.helpdesk.action', $req->id) }}" method="POST">
                                                ...
                                                <div class="modal-header">
                                                    <h5 class="modal-title">Reject Helpdesk Permission</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <div class="mb-3">
