...
<link rel="stylesheet" href="{{ asset('assets/admin/css/rate-salary.css') }}">
<link href="https://cdn.jsdelivr.net/npm/remixicon/fonts/remixicon.css" rel="stylesheet">

<div class="rate-salary-page">

    <div class="breadcrumb-text">
        Reports / Salary Reports / Rate Salary
    </div>

    <div class="page-head">
        <h4 class="page-title">Rate Salary</h4>
        <p class="page-subtitle">
            Shows details of salary earned based on rate components.
        </p>
    </div>
...
@section('script')
<script src="{{ asset('assets/admin/js/rate-salary.js') }}"></script>
@endsection