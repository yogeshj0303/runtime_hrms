...
@section('content')
<link rel="stylesheet" href="{{ asset('assets/admin/css/salary_slip.css') }}">
<link href="https://cdn.jsdelivr.net/npm/remixicon/fonts/remixicon.css" rel="stylesheet">

<div class="salary-summary-page">

    <div class="breadcrumb-text">
        Reports / Salary Reports / Salary Slips
    </div>

    <div class="page-top">
        <div>
            <h4 class="page-title">Salary Slips</h4>
            <p class="page-subtitle">
                View or download salary slips for entire organization or for selected cost center, location and/or department
            </p>
        </div>
    ...
    <p class="warning-text">
        Period is not closed. Salary Slips will be marked 'Provisional'
    </p>
    ...
    <div class="report-options-card">
        ...
        <div class="checkbox-grid">
            ...
            <div class="check-column">
                ...
                @php
                    $personal = [
                        ...
                        ['Bank Account Number', 'account', false],
                    ];
                @endphp
            ...
            <div class="check-column">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="leaveSummary" checked>
                    <label class="form-check-label" for="leaveSummary">Show Leave Summary</label>
                </div>

                <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="loanSummary" checked>
                    <label class="form-check-label" for="loanSummary">Show Loan Summary</label>
                </div>

                <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="taxSummary">
                    <label class="form-check-label" for="taxSummary">Show Tax Summary</label>
                </div>

                <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="periodDate" checked>
                    <label class="form-check-label" for="periodDate">Show Period Date</label>
                </div>

                <h6 class="mt-3">Data Summarization</h6>
        ...
        <div class="rounding-row">
            ...
            <div class="filter-group small-filter">
                ...
                <input type="text" class="filter-select" value="1">
            </div>
        </div>

        <div class="disclaimer-box">
            <label>Disclaimer</label>
            <input type="text" placeholder="This text will be printed at the bottom of each salary slip">
            <small>Max. 200 characters allowed.</small>
        </div>
...
@section('script')
<script src="{{ asset('assets/admin/js/salary_slip.js') }}"></script>
@endsection