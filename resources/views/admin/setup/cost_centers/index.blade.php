...
<div class="header-content">
    ...
    <div class="header-buttons">
        ...
        <button type="button"
            ...
            data-bs-target="#addCostCenterModal">
                        ...
                        <div class="dropdown d-inline-block">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                ...
                                <li>
                                    ...
                                    <button type="button"
                                        class="dropdown-item editCostCenterBtn"
                                        data-id="{{ $costCenter->id }}"
                                        data-name="{{ $costCenter->name }}"
                                        data-default="{{ $costCenter->is_default }}">
...
<div class="modal-dialog">
    ...
    <div class="modal-content">
        ...
        <form action="{{ route('cost-centers.store') }}"
            method="POST">
...
<div class="modal fade" id="editCostCenterModal" tabindex="-1">
...
$(document).ready(function () {
    ...
    $(document).on('click', '.editCostCenterBtn', function() {
        ...
        $('#editForm').attr(
            'action',
            "{{ url('business/setup/master/cost-centers') }}/" + id
        );
