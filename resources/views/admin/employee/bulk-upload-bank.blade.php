...
<div class="helpdesk-header">
    <div class="breadcrumb-section">
        ...
        <i class="ri-arrow-right-s-line"></i>
        <span>Bank Details Import</span>
    </div>

    <div class="header-content">
        <div class="header-left">
            <h4>Bulk Bank Details Import</h4>
            <p class="text-muted">
                Download the template, fill in the employee banking & statutory details, and upload to update multiple employees at once.
            </p>
        </div>
        <div class="header-buttons">
            <a href="{{ route('bulk-upload-bank.download-template') }}" class="btn btn-primary">
    ...
    <div class="col-lg-12">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">Upload Bank Details Data File</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('bulk-upload-bank.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
            ...
            <div class="card-body text-muted">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <ul>
                            <li><strong>Bank Name:</strong> The name of the bank (e.g. State Bank of India).</li>
                            <li><strong>Account Number:</strong> The employee's bank account number.</li>
                            <li><strong>IFSC:</strong> The bank branch IFSC code.</li>
                            <li><strong>Aadhaar Number:</strong> 12-digit Aadhaar number.</li>
                            <li><strong>PAN Number:</strong> 10-character PAN.</li>
                            <li><strong>PF UAN:</strong> Universal Account Number for Provident Fund.</li>
                            <li><strong>ESI Number:</strong> Employee State Insurance Number.</li>
                        </ul>
                    </div>
                </div>
                <div class="alert alert-info mt-3 mb-0">
                    <strong>Note:</strong> Existing bank/identity records for the employee will be updated. If a field is left empty in the CSV, it will overwrite any existing data for that field with blank.
                </div>
            </div>
        </div>
    </div>
