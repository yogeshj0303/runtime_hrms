<?php $__env->startSection('profile_title', 'Login & Access'); ?>
<?php $__env->startSection('profile_description', 'Manage employee access for mobile and web logins.'); ?>
...
<div class="row">
    ...
    <div class="col-md-5 mb-4 border-end pe-4">
        <form id="loginAccessForm" action="<?php echo e(route('employee.profile.login-access.update', ['id' => $employee->id])); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div class="row mb-2">
                ...
                <div class="col-7">
                    <span class="fs-13 fw-bold"><?php echo e($business->business_code ?? 'SOMYAH'); ?></span>
            ...
            <div class="row mb-4">
                ...
                <div class="col-7">
                    <span class="fs-13 fw-bold"><?php echo e($employee->employee_code); ?></span>
                </div>
            </div>
            ...
            <div class="form-check form-switch mb-2">
                <input class="form-check-input" type="checkbox" role="switch" id="pin_never_expires" name="pin_never_expires" value="1" <?php echo e($access && $access->pin_never_expires ? 'checked' : ''); ?>>
            ...
            <div class="form-check form-switch mb-3">
                <input class="form-check-input" type="checkbox" role="switch" id="multi_device" name="multi_device" value="1" <?php echo e($access && $access->multi_device ? 'checked' : ''); ?>>
            ...
            <div class="form-check form-switch mb-3">
                <input class="form-check-input" type="checkbox" role="switch" id="web_login" name="web_login" value="1" <?php echo e($access && $access->web_login ? 'checked' : ''); ?>>
            ...
            <div class="form-check form-switch mb-2">
                <input class="form-check-input" type="checkbox" role="switch" id="make_wall_admin" name="make_wall_admin" value="1" <?php echo e($access && $access->make_wall_admin ? 'checked' : ''); ?>>
                <label class="form-check-label fs-13" for="make_wall_admin">Make Wall Admin</label>
            </div>
            
            <div class="form-check form-switch mb-2">
                <input class="form-check-input" type="checkbox" role="switch" id="allow_wall_posting" name="allow_wall_posting" value="1" <?php echo e($access && $access->allow_wall_posting ? 'checked' : ''); ?>>
                <label class="form-check-label fs-13" for="allow_wall_posting">Allow Wall Posting</label>
            </div>
            
            <div class="form-check form-switch mb-4">
                <input class="form-check-input" type="checkbox" role="switch" id="allow_wall_comments" name="allow_wall_comments" value="1" <?php echo e($access && $access->allow_wall_comments ? 'checked' : ''); ?>>
    ...
    <div class="col-md-7 ps-4">
        ...
        <div class="row align-items-center mt-5">
            <div class="col-md-6 text-center position-relative">
                <img src="<?php echo e(asset('build/images/mobile-app-mockup.png')); ?>" onerror="this.src='https://placehold.co/200x400?text=Mobile+App'" alt="Mobile App" class="img-fluid" style="max-height: 350px;">
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.employee.profile.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/SomyaHRMS/resources/views/admin/employee/profile/login-access.blade.php ENDPATH**/ ?>