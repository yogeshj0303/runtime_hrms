        ...
        <?php $__currentLoopData = $policiesList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $historyPolicy): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if(!$historyPolicy->is_current): ?>
                ...
                <div class="list-group-item d-flex justify-content-between align-items-center p-3">
                    ...
                    <div>
                        <form action="<?php echo e(route('employee.profile.policies.destroy', ['id' => $employee->id, 'policy_id' => $historyPolicy->id])); ?>" method="POST" class="d-inline" onsubmit="return confirmDelete(event, this, 'Are you sure you want to delete this historical revision?');">
                            <?php echo csrf_field(); ?>
