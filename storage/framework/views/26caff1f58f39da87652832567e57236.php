...
<div class="setup-page">
    ...
    <div class="cardx">
        ...
        <a href="<?php echo e(route('business-units.index')); ?>" class="btn-open">Open</a>
    </div>
    ...
    <div class="cardx">
        ...
        <a href="<?php echo e(route('locations.index')); ?>" class="btn-open">Open</a>
    </div>
    ...
    <div class="cardx">
        ...
        <a href="<?php echo e(route('cost-centers.index')); ?>" class="btn-open">Open</a>
    </div>
    ...
    <div class="cardx">
        ...
        <a href="<?php echo e(route('departments.index')); ?>" class="btn-open">Open</a>
    </div>
    ...
    <div class="cardx">
        ...
        <a href="<?php echo e(route('grades.index')); ?>" class="btn-open">Open</a>
    </div>
    ...
    <div class="cardx">
        ...
        <a href="<?php echo e(route('designations.index')); ?>" class="btn-open">Open</a>
    </div>
    ...
    <div class="cardx">
        ...
        <a href="<?php echo e(route('visit-types.index')); ?>" class="btn-open">Open</a>
    </div>
    ...
    <div class="cardx">
        ...
        <a href="<?php echo e(route('helpdesk-categories.index')); ?>" class="btn-open">Open</a>
    </div>
    ...
    <div class="cardx">
        ...
        <a href="<?php echo e(route('workflows.index')); ?>" class="btn-open">Open</a>
    </div>
    ...
    <div class="cardx">
        ...
        <a href="<?php echo e(route('exit-reasons.index')); ?>" class="btn-open">Open</a>
    </div>
    ...
    <div class="cardx">
        ...
        <a href="<?php echo e(route('setup.letter-templates.index')); ?>" class="btn-open">Open</a>
    </div>
            ...
            <div class="tab-content" id="salary">
                <div class="cardx">
                    ...
                    <a href="<?php echo e(route('salary.components.index')); ?>" class="btn-open">Open</a>
                </div>
                <div class="cardx">
                    <div class="card-content">
                        <div class="icon"><i class="ri-scissors-line"></i></div>
                    ...
                    <a href="<?php echo e(route('salary.deductions.index')); ?>" class="btn-open">Open</a>
                </div>
                <div class="cardx">
                    <div class="card-content">
                        <div class="icon"><i class="ri-scissors-line"></i></div>
                    ...
                    <a href="<?php echo e(route('salary.structures.index')); ?>" class="btn-open">Open</a>
                </div>
                   <div class="cardx">
                    <div class="card-content">
                        <div class="icon"><i class="ri-scissors-line"></i></div>
                    ...
                    <a href="<?php echo e(route('overtime.index')); ?>" class="btn-open">Open</a>
                </div>
                ...
                <div class="cardx">
                    ...
                    <a href="<?php echo e(route('salary.claims.index')); ?>" class="btn-open">Open</a>
                </div>
            </div>
            ...
            <div class="tab-content" id="attendance">
                <div class="cardx">
                    ...
                    <a href="<?php echo e(route('shifts.index')); ?>" class="btn-open">Open</a>
                </div>
                ...
                <div class="cardx">
                    ...
                    <a href="<?php echo e(route('shift-policies.index')); ?>" class="btn-open">Open</a>
                </div>
                ...
                <div class="cardx">
                    ...
                    <a href="<?php echo e(route('time-rules.index')); ?>" class="btn-open">Open</a>
                </div>
                ...
                <div class="cardx">
                    ...
                    <a href="<?php echo e(route('week-off-policies.index')); ?>" class="btn-open">Open</a>
                </div>
                ...
                <div class="cardx">
                    ...
                    <a href="<?php echo e(route('attendance-settings.index')); ?>" class="btn-open">Open</a>
                </div>
                ...
                <div class="cardx">
                    ...
                    <a href="<?php echo e(route('leave-types.index')); ?>" class="btn-open">Open</a>
                </div>
                ...
                <div class="cardx">
                    ...
                    <a href="<?php echo e(route('leave-policies.index')); ?>" class="btn-open">Open</a>
                </div>
                ...
                <div class="cardx">
                    ...
                    <a href="<?php echo e(route('holidays.index')); ?>" class="btn-open">Open</a>
                </div>
                ...
                <div class="cardx">
                    ...
                    <a href="<?php echo e(route('comp-off-rules.index')); ?>" class="btn-open">Open</a>
                </div>
                ...
                <div class="cardx">
                    ...
                    <a href="<?php echo e(route('strike-rules.index')); ?>" class="btn-open">Open</a>
                </div>
                ...
                <div class="cardx">
                    ...
                    <a href="<?php echo e(route('maternity-leave-policy.index')); ?>" class="btn-open">Open</a>
                </div>
            </div>
            ...
            <div class="tab-content" id="statutory">
                <div class="cardx">
                    ...
                    <a href="<?php echo e(route('esi-settings.index')); ?>" class="btn-open">Open</a>
                </div>
                ...
                <div class="cardx">
                    ...
                    <a href="<?php echo e(route('epf-settings.index')); ?>" class="btn-open">Open</a>
                </div>
                ...
                <div class="cardx">
                    ...
                    <a href="<?php echo e(route('ptax-settings.index')); ?>" class="btn-open">Open</a>
                </div>
                ...
                <div class="cardx">
                    ...
                    <a href="<?php echo e(route('setup.statutory.lwf.index')); ?>" class="btn-open">Open</a>
                </div>
                ...
                <div class="cardx">
                    ...
                    <a href="<?php echo e(route('setup.statutory.itax.index')); ?>" class="btn-open">Open</a>
                </div>
                ...
                <div class="cardx">
                    ...
                    <a href="<?php echo e(route('setup.statutory.tds24q.index')); ?>" class="btn-open">Open</a>
                </div>
                ...
                <div class="cardx">
                    ...
                    <a href="<?php echo e(route('setup.statutory.form16.index')); ?>" class="btn-open">Open</a>
                </div>
            </div>
            ...
            <div class="tab-content" id="integration">
                ...
                <div class="cardx">
                    ...
                    <a href="<?php echo e(route('alerts.rules')); ?>" class="btn-open">Open</a>
                </div>
            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/SomyaHRMS/resources/views/admin/setup/index.blade.php ENDPATH**/ ?>