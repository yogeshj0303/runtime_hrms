            ...
            <?php if($currentWork): ?>
                ...
                <div class="mb-4">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <form action="<?php echo e(route('employee.profile.work-profile.destroy', ['id' => $employee->id, 'work_profile_id' => $currentWork->id])); ?>" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this revision?');">
                            <?php echo csrf_field(); ?>
                ...
                <div class="manager-item-box">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <?php if($currentWork && $currentWork->reporting_manager_id): ?>
                            <form action="<?php echo e(route('employee.profile.work-profile.remove-manager', ['id' => $employee->id, 'work_profile_id' => $currentWork->id, 'type' => 'reporting'])); ?>" method="POST" class="d-inline" onsubmit="return confirm('Remove reporting manager?');">
                                <?php echo csrf_field(); ?>
                ...
                <div class="manager-item-box">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <?php if($currentWork && $currentWork->hr_manager_id): ?>
                            <form action="<?php echo e(route('employee.profile.work-profile.remove-manager', ['id' => $employee->id, 'work_profile_id' => $currentWork->id, 'type' => 'hr'])); ?>" method="POST" class="d-inline" onsubmit="return confirm('Remove HR manager?');">
                                <?php echo csrf_field(); ?>
                                <button type="submit" class="btn-circle-delete" title="Remove Manager">
                                    <i class="ri-delete-bin-line"></i>
                                </button>
                ...
                <div class="manager-item-box">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <?php if($currentWork && $currentWork->indirect_manager_id): ?>
                            <form action="<?php echo e(route('employee.profile.work-profile.remove-manager', ['id' => $employee->id, 'work_profile_id' => $currentWork->id, 'type' => 'indirect'])); ?>" method="POST" class="d-inline" onsubmit="return confirm('Remove Indirect manager?');">
                                <?php echo csrf_field(); ?>
                                <button type="submit" class="btn-circle-delete" title="Remove Manager">
                                    <i class="ri-delete-bin-line"></i>
                                </button>
