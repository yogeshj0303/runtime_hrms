<?php $__env->startSection('profile_title', 'Documents'); ?>
<?php $__env->startSection('profile_description', 'Add, download and manage employee documents.'); ?>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <a href="<?php echo e(asset($doc->document_file)); ?>" target="_blank" class="fw-semibold text-primary fs-13"><?php echo e($doc->document_name); ?></a>
                                    </div>
                                </div>
                            </td>
                            <td class="text-muted small"><?php echo e($doc->description ?? '-'); ?></td>
                            <td>
                            ...
                            <td class="text-end">
                                <a href="<?php echo e(asset($doc->document_file)); ?>" target="_blank" class="btn btn-sm btn-light btn-icon me-1" title="View/Download">
                                    <i class="ri-download-2-line"></i>
                                </a>
                                <form action="<?php echo e(route('employee.profile.documents.destroy', $doc->id)); ?>" method="POST" class="d-inline-block" onsubmit="return confirmDelete(event, this, 'Are you sure you want to delete this document?');">
                                    <?php echo csrf_field(); ?>
...
<div class="modal fade" id="addDocumentModal" tabindex="-1" aria-labelledby="addDocumentModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow">
            ...
            <form action="<?php echo e(route('employee.profile.documents.store')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.employee.profile.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/SomyaHRMS/resources/views/admin/employee/profile/documents.blade.php ENDPATH**/ ?>