                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                ...
                                <form action="<?php echo e(route('employee.profile.documents.destroy', $doc->id)); ?>" method="POST" class="d-inline-block" onsubmit="return confirm('Are you sure you want to delete this document?');">
                                    <?php echo csrf_field(); ?>
