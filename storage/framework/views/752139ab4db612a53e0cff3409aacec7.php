<?php $__env->startSection('profile_title', 'Addresses'); ?>
<?php $__env->startSection('profile_description', "Keep record of employee's present and permanent address"); ?>
...
<?php if($employee->addresses->count() == 0): ?>
...
<?php else: ?>
<div class="row">
    <?php $__currentLoopData = $employee->addresses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $address): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="col-md-6 mb-3">
        <div class="card shadow-none border h-100">
            <div class="card-body">
                <div class="d-flex justify-content-between mb-2">
                    <span class="badge bg-light text-dark border"><?php echo e($address->type); ?></span>
                    <div>
                        <a href="javascript:void(0)" class="text-primary me-2" onclick="editAddress(<?php echo e($address); ?>)"><i class="ri-pencil-line"></i></a>
                        <a href="javascript:void(0)" class="text-danger" onclick="confirmDelete(event, 'delete-address-<?php echo e($address->id); ?>', 'Are you sure you want to delete this address?');"><i class="ri-delete-bin-line"></i></a>
                        <form id="delete-address-<?php echo e($address->id); ?>" action="<?php echo e(route('employee.profile.address.destroy', $address->id)); ?>" method="POST" class="d-none">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('DELETE'); ?>
                        </form>
                    </div>
                </div>
                <p class="mb-1 text-dark fs-6"><?php echo e($address->address1); ?> <?php echo e($address->address2); ?></p>
                <p class="mb-0 text-muted small"><?php echo e($address->city); ?>, <?php echo e($address->state); ?> <?php echo e($address->zipcode); ?></p>
...
<div class="modal fade" id="addressModal" tabindex="-1" aria-labelledby="addressModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow">
            ...
            <form action="<?php echo e(route('employee.profile.address.store')); ?>" method="POST" id="addressForm">
                <?php echo csrf_field(); ?>
...
<script>
    function resetAddressForm() {
        ...
        document.getElementById('addressForm').action = "<?php echo e(route('employee.profile.address.store')); ?>";
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.employee.profile.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/SomyaHRMS/resources/views/admin/employee/profile/address.blade.php ENDPATH**/ ?>