<?php $__env->startSection('profile_title', 'Loans & Advances'); ?>
<?php $__env->startSection('profile_description', 'Manage loans and advances for this employee'); ?>
                ...
                <table class="table table-bordered table-hover" style="font-size: 13px;">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $loans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($loan->issue_date->format('d M, Y')); ?></td>
                                <td style="font-weight: 600; color: #133C5A;">₹<?php echo e(number_format($loan->loan_amount, 2)); ?></td>
                                <td>₹<?php echo e(number_format($loan->emi_amount, 2)); ?></td>
                                <td><?php echo e($loan->tenure_months); ?> Months</td>
                                <td><?php echo e($loan->repayment_start_date->format('M Y')); ?></td>
                                <td>
                                    <?php if($loan->status == 'Active'): ?>
                                        <span class="badge bg-success">Active</span>
                                    <?php else: ?>
                                        <span class="badge bg-secondary"><?php echo e($loan->status); ?></span>
                                    <?php endif; ?>
                                </td>
                                <td>
                                    <button class="btn btn-sm btn-outline-primary" type="button" data-bs-toggle="collapse" data-bs-target="#schedule-<?php echo e($loan->id); ?>">
                                        View Schedule
                                    </button>
                                </td>
                            </tr>
                            <tr class="collapse" id="schedule-<?php echo e($loan->id); ?>">
                                <td colspan="7" style="background: #f8f9fa; padding: 15px;">
                                    ...
                                    <table class="table table-sm table-bordered bg-white" style="font-size: 11px;">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $loan->installments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inst): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td><?php echo e($inst->installment_date->format('F Y')); ?></td>
...
<div class="modal fade" id="addLoanModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('employee.profile.loans.store', $employee->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="modal-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="date" name="issue_date" class="form-control" required value="<?php echo e(date('Y-m-d')); ?>">
                        </div>
                        <div class="col-md-6">
...
<?php echo $__env->make('admin.employee.profile.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/SomyaHRMS/resources/views/admin/employee/profile/loans.blade.php ENDPATH**/ ?>