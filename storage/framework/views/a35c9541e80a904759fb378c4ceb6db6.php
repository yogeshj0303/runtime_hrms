    ...
    <div class="header-content d-flex justify-content-between align-items-center">
        ...
        <div class="header-right d-flex flex-column align-items-end gap-2">
            ...
            <div class="d-flex gap-2">
                <a href="<?php echo e(route('onboarding.create')); ?>" class="btn btn-sm text-white" style="background-color: #162d50;">
                    <i class="ri-user-add-line align-middle me-1"></i> New Employee
                </a>
                <a href="<?php echo e(route('onboarding.forms.create')); ?>" class="btn btn-sm text-white" style="background-color: #162d50;">
            ...
            <!-- Date Range Filter -->
            <form action="<?php echo e(route('onboarding.index')); ?>" method="GET" class="d-flex align-items-center gap-2 bg-white p-1 px-2 rounded border mt-1">
                <input type="date" name="start_date" class="form-control form-control-sm border-0" value="<?php echo e($startDate); ?>">
                <span class="text-muted fs-12">to</span>
                <input type="date" name="end_date" class="form-control form-control-sm border-0" value="<?php echo e($endDate); ?>">
    ...
    <div class="col-xl-3 col-sm-6">
        <div class="card metric-card border-0 shadow-sm">
            <div class="card-body d-flex align-items-center">
                ...
                <div>
                    <h5 class="fs-18 mb-1"><?php echo e($totalForms); ?></h5>
    ...
    <div class="col-xl-3 col-sm-6">
        <div class="card metric-card border-0 shadow-sm">
            <div class="card-body d-flex align-items-center">
                ...
                <div>
                    <h5 class="fs-18 mb-1"><?php echo e($offersSent); ?></h5>
    ...
    <div class="col-xl-3 col-sm-6">
        <div class="card metric-card border-0 shadow-sm">
            <div class="card-body d-flex align-items-center">
                ...
                <div>
                    <h5 class="fs-18 mb-1"><?php echo e($inProgress); ?></h5>
    ...
    <div class="col-xl-3 col-sm-6">
        <div class="card metric-card border-0 shadow-sm">
            <div class="card-body d-flex align-items-center">
                ...
                <div>
                    <h5 class="fs-18 mb-1"><?php echo e($totalHires); ?></h5>
    ...
    <div class="col-lg-4">
        <div class="card border-0 shadow-sm h-100">
            ...
            <div class="card-body d-flex justify-content-center align-items-center">
                <?php if(array_sum($completionData) > 0): ?>
        ...
        <div class="card border-0 shadow-sm h-100">
            ...
            <div class="card-body p-0 mt-3" style="max-height: 250px; overflow-y: auto;">
                <ul class="list-group list-group-flush">
                    <?php $__empty_1 = true; $__currentLoopData = $forms->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $form): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <li class="list-group-item d-flex justify-content-between align-items-center px-4 py-3">
                            <div>
                                <h6 class="fs-13 mb-1 text-dark fw-semibold"><?php echo e($form->form_name ?? ($form->employee->first_name . ' ' . $form->employee->last_name)); ?></h6>
                                <p class="fs-11 text-muted mb-0">Created: <?php echo e($form->created_at->format('d-M-Y')); ?></p>
                            </div>
                            <div>
...
<div class="row mb-4">
    <div class="col-lg-12">
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body">
                <?php if(array_sum($trendCounts) > 0): ?>
            ...
            <table id="formsTable" class="table table-bordered table-hover align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><strong><?php echo e($form->form_name); ?></strong></td>
                        <td>
                            <?php echo e($form->employee->first_name); ?> <?php echo e($form->employee->last_name); ?>

                            <br><small class="text-muted"><?php echo e($form->employee->email); ?></small>
                        </td>
                        <td><?php echo e($form->employee->employee_code); ?></td>
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="<?php echo e(route('employee.profile.summary', ['id' => $form->employee_id])); ?>" class="dropdown-item">
...
<script>
    $(document).ready(function() {
        ...
        if (document.getElementById("onboardingOverviewChart")) {
            ...
            var totalCount = <?php echo array_sum($completionData); ?>;
            var percentComplete = totalCount > 0 ? Math.round((<?php echo $completionData[0]; ?> / totalCount) * 100) : 0;
            
            var overviewOptions = {
                series: <?php echo json_encode($completionData); ?>,
                chart: {
                    type: 'donut',
                    height: 250
                },
        ...
        if (document.getElementById("hiresByDeptChart")) {
            ...
            var deptNames = <?php echo json_encode($deptNames); ?>;
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/SomyaHRMS/resources/views/admin/employee/onboarding/index.blade.php ENDPATH**/ ?>