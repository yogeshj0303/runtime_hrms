...
(function() {
    ...
    <?php if(isset($errors) && $errors->any()): ?>
        document.addEventListener('DOMContentLoaded', function() {
            const serverErrors = <?php echo json_encode($errors->toArray(), 15, 512) ?>;
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/SomyaHRMS/resources/views/layouts/vendor-scripts.blade.php ENDPATH**/ ?>